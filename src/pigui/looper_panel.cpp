...
LooperPanel::init()
{
	...
	//colsizer->Add (_pause_button, 0, wxTOP, 5);
...
// 	lilrowsizer->Add (_round_check, 0, wxEXPAND);
	...
	//lilcolsizer->Add (_pause_button, 0, wxTOP, 0);
	lilcolsizer->Add (lilrowsizer, 0, wxTOP|wxEXPAND, 0);
...
*/
	...
	*/
	...
	rowsizer = new wxBoxSizer(wxHORIZONTAL);
	rowsizer->Add (_load_button, 0, wxTOP|wxLEFT, 2);
        rowsizer->Add (_save_button, 0, wxTOP|wxLEFT, 2);
        rowsizer->Add (_trig_button, 0, wxTOP|wxLEFT, 2);
        rowsizer->Add (_once_button, 0, wxTOP|wxLEFT, 2);
	colsizer->Add (rowsizer, 0, wxEXPAND|wxLEFT, 1);
